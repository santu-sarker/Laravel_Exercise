...
class Global_Contact extends Model
{
    use HasFactory;
    protected $table = 'global_contacts';

    protected $fillable = ['name', 'email', 'phone', 'company', 'address', 'gender', 'creator_type', 'user_id'];
